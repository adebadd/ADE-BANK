...
public class Customerlogin extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        btnlogin.setBackground(new java.awt.Color(2, 94, 144));
        ...
        jtfAccountID.setBackground(new java.awt.Color(0, 153, 204));
        jtfAccountID.setFont(new java.awt.Font("Arial", 1, 14)); // NOI18N
        jtfAccountID.setBorder(null);
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addComponent(jtfAccountID, javax.swing.GroupLayout.PREFERRED_SIZE, 304, javax.swing.GroupLayout.PREFERRED_SIZE)
        ...
        jPanel1Layout.setVerticalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addComponent(lblaccount)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(jtfAccountID, javax.swing.GroupLayout.PREFERRED_SIZE, 21, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
  ...
  // <editor-fold defaultstate="collapsed" desc="Generated Code">                          
    ...
    private void btnloginMouseClicked(java.awt.event.MouseEvent evt) {
    	...
    	Customer customers;
        String customerID = jtfAccountID.getText();
        String customerpass = jpfPassword.getText();
        
        
     if (Customer.customerexists(customerpass, customerID)) {
    	 this.dispose();
    	 AdeBank.Instance.getLblbalance().setEnabled(true);
    	 AdeBank.Instance.getLblwithdraw().setEnabled(true);
    	 AdeBank.Instance.getLblviewdetails().setEnabled(true);
    	 AdeBank.Instance.getLbllogout().setEnabled(true);
         AdeBank.Instance.getLbllodgement().setEnabled(true);
         AdeBank.Instance.getLbllogin().setEnabled(false);
    	 AdeBank.Instance.getLblcreate().setEnabled(false);
