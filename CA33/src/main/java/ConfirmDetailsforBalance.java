 ...
 * @author Speed
 */
public class ConfirmDetailsforBalance extends javax.swing.JFrame {

    ArrayList<Customer> Customerinfo = new ArrayList<>();
    public static ConfirmDetailsforBalance Instance;
    /**
     * Creates new form AdeBankingDriver
     */
    public ConfirmDetailsforBalance() {
  ...
  // <editor-fold defaultstate="collapsed" desc="Generated Code">                          
    ...
    private void btnconfirmMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnconfirmMouseClicked
        ...
        if (foundCustomer == null) {
            ...
            custname = foundCustomer.getCustomerFirst();
            accountNumber = foundCustomer.getAccountNum();
            this.dispose();
            
               new BalanceReport().setVisible(true);
               
       numberforbalance = ConfirmDetailsforBalance.Instance.getAccountNumber();
       CustomerAccount foundAccount = AccountTransactions.findAccount(numberforbalance);
        if (foundAccount== null) {
            //if customer is NOT found 
        	  new ErrorCustomer().setVisible(true);
        } else {
            double balanceAmount;
            balanceAmount = foundAccount.getCustomerBalance();
            this.dispose();
            BalanceReport.Instance.getLblamount().setText(Double.toString(balanceAmount)); 
            BalanceReport.Instance.getLblprintname().setText("Hello, " + custname);
