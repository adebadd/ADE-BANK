...
public class AdminLogin1 extends javax.swing.JFrame {
 ...
 ArrayList<Administator> mainAdmin;
    ...
    private void initComponents() {
        ...
        lbladminlog.setText("LOGIN ADMINISTATOR");
  ...
  // <editor-fold defaultstate="collapsed" desc="Generated Code">                          
    ...
    adminpass = jpfPassword.getText();
      	 ...
      	 if (Administator.adminexists(adminusername,adminpass)) {
        	 this.dispose();
        	 AdeBank.Instance.getJpcustomerlist().setVisible(true);
         } else {
        	 
        	 new ErrorLoginAdmin().setVisible(true);
        	 jtfUserName.setText("");
        	 jpfPassword.setText("");
         }
