...
/** Student Name: Abdul Badmo
 * Student Number: C21325446
 *  OOSD2 CA3
 */
public class AdeBankingDriver extends javax.swing.JFrame {
boolean isclicked = false;
 ArrayList<Administator> mainAdmin;
    /**
     * Creates new form AdminLogin
     */
    public AdeBankingDriver() {
    ...
    private void initComponents() {
        ...
        lbladminlog.setText("CREATE ADMINISTATOR");
        ...
        jtfUserName.setBackground(new java.awt.Color(0, 153, 204));
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addComponent(jtfUserName, javax.swing.GroupLayout.PREFERRED_SIZE, 304, javax.swing.GroupLayout.PREFERRED_SIZE)
        ...
        jPanel1Layout.setVerticalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addComponent(lblusername)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(jtfUserName, javax.swing.GroupLayout.PREFERRED_SIZE, 21, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
  ...
  // <editor-fold defaultstate="collapsed" desc="Generated Code">                          
    ...
    private void btncreateActionPerformed(java.awt.event.ActionEvent evt) {                                          
     ...
     adminusername = jtfUserName.getText();
    adminpass = jpfPassword.getText();
     if (adminpass.length()<7){
         
   new ErrorAdmin().setVisible(true);
    
     }
     else{
         Administator Admin = new Administator(adminusername,adminpass);
         Administator.listofAdmins.add(Admin);
     this.dispose();
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            ...
            public void run() {
                ...
                new AdeBankingDriver().setVisible(true);
            }
        });
    }
